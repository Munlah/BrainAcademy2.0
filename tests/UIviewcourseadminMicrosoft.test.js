...
describe.only('Testing Add and View Course in Microsoft Edge', function () {
    this.timeout(30000);
    var driver; // Declare a WebDriver variable
    var counter = 0;

    before(async () => {
        // Initialize a Microsoft Edge WebDriver instance
    ...
    it('Should add a course with valid inputs and handle success alert', async () => {
        ...
        await topicInput.sendKeys('Cells');
        await descriptionInput.sendKeys('Cells for sec 2');
        await videoInput.sendKeys('https://youtu.be/nTn9gVqRfKY?si=c0QLpMvbBcquwsZV');
        await categoryInput.sendKeys('Bio');
    ...
    it('Should show an error alert for exsiting topic', async () => {
        ...
        await topicInput.sendKeys('Cells');
        await descriptionInput.sendKeys('sec 2');
        await videoInput.sendKeys('https://youtu.be/nTn9gVqRfKY?si=c0QLpMvbBcquwsZV');
        await categoryInput.sendKeys('Bio');
    ...
    it('Should show an error alert for exsiting description', async () => {
        ...
        await topicInput.sendKeys('Plants');
        await descriptionInput.sendKeys('Cells for sec 2');
        await videoInput.sendKeys('https://youtu.be/nTn9gVqRfKY?si=c0QLpMvbBcquwsZV');
        await categoryInput.sendKeys('Bio');
